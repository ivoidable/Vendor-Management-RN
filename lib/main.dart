    ...
    return GetMaterialApp(
      ...
      theme: ThemeData(
        ...
        primaryTextTheme: TextTheme(
          bodyLarge: Get.textTheme.titleLarge!.copyWith(color: Colors.black),
          bodyMedium: Get.textTheme.titleLarge!.copyWith(color: Colors.black),
          bodySmall: Get.textTheme.titleLarge!.copyWith(color: Colors.black),
          titleLarge: Get.textTheme.titleLarge!.copyWith(color: Colors.black),
          titleMedium: Get.textTheme.titleLarge!.copyWith(color: Colors.black),
          titleSmall: Get.textTheme.titleLarge!.copyWith(color: Colors.black),
        ),
